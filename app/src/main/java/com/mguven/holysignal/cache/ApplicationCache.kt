...
/*  fun updateSearchKeyword(words: String) =
  ...
  fun getSearchKeyword() =
    ...
    fun updateSpotlightShownState(state: Boolean) =
            this.applicationSharedPreferences.edit().putBoolean(CacheKey.SPOTLIGHT_SHOWN_STATE, state).apply()

    fun isSpotlightShown(): Boolean =
            this.applicationSharedPreferences.getBoolean(CacheKey.SPOTLIGHT_SHOWN_STATE, false)
