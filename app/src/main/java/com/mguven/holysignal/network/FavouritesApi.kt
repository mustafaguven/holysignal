...
interface FavouritesApi {
  ...
  suspend fun addFavourite(@Body body: RequestAddFavourites): ResponseEntity<AddFavouritesResponseEntity>

  @GET("favourites/getfavouritecountbyayahnumber")
  suspend fun getFavouriteCountByAyahNumber(@Query("ayahNumber") ayahNumber: Int): ResponseEntity<Int>
